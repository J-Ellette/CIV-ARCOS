...
### 5. static_analyzer.py - Static Code Analyzer
...
### 6. security_scanner.py - Security Scanner
...
### 7. test_generator.py - Test Generator
...
### 9. dashboard.py - Web Dashboard with USWDS
...
### 10. fragments.py - CertGATE Assurance Case Fragments
...
### 11. argtl.py - Argument Transformation Language
...
### 12. acql.py - Assurance Case Query Language
...
### 13. reasoning.py - CLARISSA Reasoning Engine
...
### 14. dependency_tracker.py - CAID-tools Dependency Tracking
...
### 15. architecture.py - A-CERT Architecture Mapping
...
### 16. collector.py - RACK-like Evidence Collection
